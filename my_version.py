...
def perform_fft_normalize(int_beam_env, area_nf, dpp_phase):
	...
	efield_beam_env  = np.exp(-1j)*int_beam_env**0.5                 #V/m    #proportionality relation. E field amplitude squared is proportional to intensity
	...
	return xff1d, xff, dxff, yff1d, yff, dyff, int_ff, far_field_ideal, pwr_beam_env
